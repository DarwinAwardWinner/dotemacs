...
(custom-set-variables
 ...
 '(desktop-locals-to-save
   '(desktop-locals-to-save truncate-lines case-fold-search case-replace
                            ...
                            buffer-file-coding-system indent-tabs-mode
 ...
 '(diminished-minor-modes
   '((volatile-highlights-mode . "") (eldoc-mode . "")
     (filladapt-mode . "") (highlight-parentheses-mode . "")
     (autopair-mode . "") (auto-complete-mode . "") (cua-mode . "")
     (ws-butler-mode . "") (undo-tree-mode . "") (anzu-mode . "")
     (auto-dim-other-buffers-mode . "") (highlight-changes-mode . "")
     (magit-auto-revert-mode . "") (git-gutter-mode . "")
     (ws-butler-mode . "") (editorconfig-mode . "")
     (magit-filenotify-mode . "") (which-key-mode . "")
     (highlight-stages-mode . "") (bar-cursor-mode . "")
     (beacon-mode . "") (magit-filenotify-mode . "")))
 ...
 '(elfeed-feeds
   '("http://www.rna-seqblog.com/feed/"
     ...
     "http://owncloudtest.blogspot.com/feeds/posts/default"
     "http://feeds.feedburner.com/d0od"
     "http://blog.dustinkirkland.com/feeds/posts/default"
     "http://www.aaronsw.com/2002/feeds/pgessays.rss"
     "http://steve-yegge.blogspot.com/feeds/posts/default"
     "http://www.phdcomics.com/gradfeed.php"
     "http://blag.xkcd.com/feed/"
     "http://www.bioconductor.org/rss/new_packages.rss"
     "http://newsboyhat.co.uk/?feed=rss2"
     "http://www.modernperlbooks.com/mt/atom.xml"
     "http://what-if.xkcd.com/feed.atom"
     "http://www.oak-tree.us/blog/index.php/feed"
 ...
 '(face-font-family-alternatives
   '(("Monospace" "courier" "fixed")
     ...
     ("DejaVu Sans Mono" "Source Code Pro" "Ubuntu Mono" "Monospace"
      "courier" "fixed")
 ...
 '(hardhat-fullpath-protected-regexps
   '("~/\\.cask/" "~/\\.emacs\\.d/\\.cask/" "~/\\.emacs\\.d/elpa/"
     "~/\\.cpan/" "~/\\.cabal/" "~/perl5/perlbrew/" "~/\\.npm/"
     "~/\\.virtualenv/" "~/\\.virthualenv/" "~/\\.rvm/" "/[._]build/"
     "/\\.bzr/" "/\\.coverage/" "/\\.git/" "/\\.hg/" "/\\.rspec/"
     "/\\.sass-cache/" "/\\.svn/" "/_MTN/" "/_darcs/" "/CVS/"
     "/pm_to_blib/" "/RCS/" "/SCCS/" "/blib/" "/test_output/"))
 '(hes-mode t)
 '(hes-mode-alist
   '((c-mode
      . "\\(\\\\\\([0-7]\\{1,3\\}\\|x[[:xdigit:]]+\\|u[[:xdigit:]]\\{4\\}\\|U[[:xdigit:]]\\{8\\}\\|[\"'?\\abfnrtv]\\)\\)")
     (c++-mode
      . "\\(\\\\\\([0-7]\\{1,3\\}\\|x[[:xdigit:]]+\\|u[[:xdigit:]]\\{4\\}\\|U[[:xdigit:]]\\{8\\}\\|[\"'?\\abfnrtv]\\)\\)")
     (objc-mode
      . "\\(\\\\\\([0-7]\\{1,3\\}\\|x[[:xdigit:]]+\\|u[[:xdigit:]]\\{4\\}\\|U[[:xdigit:]]\\{8\\}\\|[\"'?\\abfnrtv]\\)\\)")
     (java-mode
      . "\\(\\\\\\([0-7]\\{1,3\\}\\|u[[:xdigit:]]\\{4\\}\\|[\"'\\bfnrt]\\)\\)")
     (clojure-mode
      . "\\(\\\\\\([0-7]\\{1,3\\}\\|u[[:xdigit:]]\\{4\\}\\|[\"'\\bfnrt]\\)\\)")
     (js-mode
      . "\\(\\\\\\([0-7]\\{1,3\\}\\|x[[:xdigit:]]\\{2\\}\\|u[[:xdigit:]]\\{4\\}\\|.\\)\\)")
     (js2-mode
      . "\\(\\\\\\([0-7]\\{1,3\\}\\|x[[:xdigit:]]\\{2\\}\\|u[[:xdigit:]]\\{4\\}\\|.\\)\\)")
     (ruby-mode
      ("\\(\\\\\\([0-7]\\{1,3\\}\\|x[[:xdigit:]]\\{1,2\\}\\|u\\(?:[[:xdigit:]]\\{4\\}\\|{[[:xdigit:]]\\{1,6\\}\\(?:[[:space:]]+[[:xdigit:]]\\{1,6\\}\\)*}\\)\\|.\\)\\)"
       (0
        (let* ((state (syntax-ppss)) (term (nth 3 state)))
          (when
              (or
               (and (eq term 39) (member (match-string 2) '("\\" "'")))
               (if (fboundp 'ruby-syntax-expansion-allowed-p)
                   (ruby-syntax-expansion-allowed-p state)
                 (memq term '(34 47 10 96 t))))
            (font-lock-prepend-text-property (match-beginning 1)
                                             (match-end 1) 'face
                                             'hes-escape-backslash-face)
            (font-lock-prepend-text-property (match-beginning 2)
                                             (match-end 2) 'face
                                             'hes-escape-sequence-face)
            nil))
        prepend)))
     (emacs-lisp-mode
      . "\\(\\\\\\(u[[:xdigit:]]\\{4\\}\\|U00[[:xdigit:]]\\{6\\}\\|x[[:xdigit:]]+\\|[0-7]+\\|.\\)\\)")
 ...
 '(indent-guide-inhibit-modes
   '(tabulated-list-mode special-mode dired-mode eww-mode eshell-mode
                         Custom-mode ess-mode))
 ...
 '(make-header-hook
   '(header-title header-completely-blank header-copyright
                  header-completely-blank header-file-name
                  header-author header-creation-date header-version
                  header-pkg-requires header-url header-keywords
                  header-completely-blank header-not-part-of-emacs
                  header-completely-blank header-end-line
                  header-commentary header-completely-blank
                  header-blank header-completely-blank header-end-line
                  header-free-software header-code
                  header-provide-statement header-eof))
 ...
 '(org-html-infojs-options
   '((path . "http://orgmode.org/org-info.js") (view . "overview")
 ...
 '(org-todo-keyword-faces
   '(("DONE" . "darkgreen") ("CANCELLED" . "darkred")
     ("REJECTED" . "darkred") ("WAITING" . "chocolate1")
     ("WAIT" . "chocolate1") ("ON HOLD" . "chocolate2")))
 '(org-todo-keywords
 ...
 '(pretty-symbol-patterns
   '((955 lambda "\\<lambda\\>"
     ...
     (402 lambda "\\<function\\>" (js-mode))
     (8800 relational "!="
           (c-mode c++-mode go-mode java-mode js-mode perl-mode
                   cperl-mode ruby-mode python-mode
     ...
     (8805 relational ">="
           (c-mode c++-mode go-mode java-mode js-mode perl-mode
                   cperl-mode ruby-mode python-mode
                   inferior-python-mode emacs-lisp-mode
                   inferior-lisp-mode lisp-mode scheme-mode))
     (8804 relational "<="
           (c-mode c++-mode go-mode java-mode js-mode perl-mode
                   cperl-mode ruby-mode python-mode
                   inferior-python-mode emacs-lisp-mode
 ...
 '(safe-local-variable-values
   '((elisp-lint-indent-specs (git-gutter:awhen . 1))
     ...
     (eval add-hook 'kill-buffer-hook
           (apply-partially #'message "Clipboard cleared.") nil t)
     ...
     (checkdoc-symbol-words quote
                            ("UNREPL" "unrepl" "stdout" "print-level"
                             "print-length"))
     (eval add-hook 'after-save-hook
           (lambda nil
             (save-mark-and-excursion
           ...
           t t)
     (eval add-hook 'kill-buffer-hook (apply-partially #'kill-new "")
           nil t)
     (eval add-hook 'after-save-hook
           (lambda nil
             (save-mark-and-excursion
     ...
     (eval add-hook 'after-save-hook
           (lambda nil
             (save-mark-and-excursion
               (deactivate-mark 'force)
               (org-export-to-file 'html "character sheet.html"
                 t nil nil nil
                 `(:exclude-tags
                   ,(append '("secret" "hidden")
     ...
     (eval add-hook 'after-save-hook
           (lambda nil
             (save-mark-and-excursion
               (deactivate-mark 'force)
               (org-export-to-file 'html "Public/character sheet.html"
                 t nil nil nil
                 `(:exclude-tags
                   ,(append '("secret" "hidden")
                            org-export-exclude-tags)))))
           t t)
     (org-todo-keyword-faces ("TODO" . "red") ("WAIT" . "orange")
                             ("DONE" . "forestgreen")
                             ("CANCELED" . "RosyBrown4"))
     (eval add-hook 'after-save-hook
           (lambda nil
           ...
           t t)
     (eval set (make-local-variable 'mouse-1-click-follows-link) nil)
     (eval add-hook 'after-save-hook
           (lambda nil
             (save-mark-and-excursion
               (deactivate-mark 'force)
           ...
           t t)
     (eval add-hook 'after-save-hook
           (lambda nil (org-export-to-file 'html "index.html" t)) t t)
     (eval add-hook 'after-save-hook
           (lambda nil
             (save-mark-and-excursion
               (deactivate-mark 'force)
           ...
           t t)
     (eval add-hook 'after-save-hook
           (lambda nil (require 'async)
             (async-start
              `(lambda nil
                 (load ,(expand-file-name "export-campaign.el")))
              (lambda (result) (message "Export complete."))))
           t t)
     ...
     (eval add-hook 'after-save-hook
           ...
           t t)
     (major-mode . LaTeX) (eval org-display-inline-images)
     ...
     (org-emphasis-alist ("*" bold) ("/" italic) ("_" underline)
                         ("=" org-verbatim verbatim)
                         ("~" org-code verbatim))
     (checkdoc-minor-mode . 1) (eval ignore-errors (ws-butler-mode 0))
     (flycheck-disabled-checkers '(emacs-lisp emacs-lisp-checkdoc))
     (whitespace-style face tabs trailing lines-tail)
     (eval if (fboundp 'pretty-symbols-mode) (pretty-symbols-mode -1))
     (c-indentation-style . bsd) (mangle-whitespace . t)
     ...
     (require-final-newline . t) (outline-minor-mode)
     (whitespace-style face tabs spaces trailing lines
                       space-before-tab::space newline
                       indentation::space empty space-after-tab::space
 ...
 '(tempbuf-temporary-major-modes
   '(Custom-mode w3-mode Man-mode view-mode help-mode apropos-mode
                 completion-list-mode dired-mode ibuffer-mode
                 bookmark-bmenu-mode ess-help-mode compilation-mode
                 vc-dir-mode vc-hg-log-view-mode occur-mode diff-mode
