...
")
 ...
 '(package-selected-packages
   (quote
    (a ace-window adaptive-wrap adjust-parens aggressive-indent amx anzu apache-mode apples-mode async auto-complete auto-dim-other-buffers autopair avy bar-cursor beacon better-shell bind-key buttercup cask cask-mode cl-lib cl-lib-highlight commander counsel creole-mode crm-custom crontab-mode crux dash diminish ecukes edit-indirect editorconfig el-get epl ess ess-R-data-view ess-R-object-popup ess-smart-underscore esup exec-path-from-shell f feature-mode fireplace fringe-helper git git-commit git-gutter git-gutter-fringe github-browse-file github-clone gitignore-mode git-wip-mode guide-key hardhat haskell-mode header2 helm help-fns+ highlight-defined highlight-escape-sequences highlight-stages ht hydra ido-complete-space-or-hyphen ido-completing-read+ ido-load-library ido-yes-or-no image+ iqa isearch+ ivy-hydra jedi julia-mode keydef lexbind-mode log4e mac-pseudo-daemon macrostep magit magit-filenotify magit-find-file magit-gh-pulls magithub magit-popup markdown-mode md-readme memoize multiple-cursors nameless neotree nginx-mode noflet occur-context-resize org org-bullets org-plus-contrib osx-pseudo-daemon package-build package-lint pallet paradox pcre2el pdf-tools php-mode pkg-info pointback polymode popup pretty-symbols pyenv-mode py-isort python python-mode rainbow-delimiters req-package restart-emacs reveal-in-osx-finder s scratch-ext shrink-whitespace shut-up slime sml-modeline smooth-scrolling snakemake-mode sr-speedbar string-edit swiper sx systemd system-specific-settings tempbuf toc-org transmission transpose-frame travis undercover undo-tree use-package volatile-highlights which-key with-editor with-simulated-input ws-butler yaml-mode zone-nyan zone-rainbow zone-select zone-sl ztree)))
