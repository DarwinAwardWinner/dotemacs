...
during Emacs' startup process. Right now, it just contains code
recommended by the Straight package manager for turning off
package.el.
      ...
      (let ((init-comment
            ...
            (init-form
             `(progn
                ...
                (message "org-file-name-concat function: %s"
                         (symbol-function 'org-file-name-concat))
                (require 'ox)
