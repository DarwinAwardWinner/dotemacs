...
#+BEGIN_SRC emacs-lisp
  ...
  (add-to-list
     'el-get-sources
     '(:name ido-describe-fns
             :type http
             :url "https://github.com/DarwinAwardWinner/ido-ubiquitous/raw/bleeding-edge/ido-describe-fns.el"
             :features ido-describe-fns
             :depends (ido-completing-read+ ido-ubiquitous)))
#+END_SRC
